...
{
    this->ui->yourCodeLEdit->setText(QFileDialog::getOpenFileName(this, tr("Choose Your Code"), "/home"));
}

void MainWindow::on_corrCodeBtn_clicked()
{
    this->ui->corrCodeLEdit->setText(QFileDialog::getOpenFileName(this, tr("Choose Correct Code"), "/home"));
}

void MainWindow::on_tstMakerBtn_clicked()
{
    this->ui->tstMakerLEdit->setText(QFileDialog::getOpenFileName(this, tr("Choose Test Maker Code"), "/home"));
}
...
void MainWindow::on_judgeBtn_clicked()
{
    ...
    if(!Judge::compileCode(ui->yourCodeCommandLEdit->text(),ui->yourCodeLEdit->text(),QString("a")))
    {
    ...
    if(!Judge::compileCode(ui->corrCodeCommandLEdit->text(),ui->corrCodeLEdit->text(),QString("b")))
    {
    ...
    if(!Judge::compileCode(ui->tstMakerCommandLEdit->text(),ui->tstMakerLEdit->text(),QString("c")))
    {
...
void MainWindow::on_yourCodeLangCbox_currentIndexChanged(const QString &arg1)
{
    if(arg1.toStdString() == "C")
        ui->yourCodeCommandLEdit->setText("gcc -lm");
    if(arg1.toStdString() == "C++")
        ui->yourCodeCommandLEdit->setText("g++ -lm");
    if(arg1.toStdString() == "Other")
        ui->yourCodeCommandLEdit->clear();
}

void MainWindow::on_corrCodeLangCbox_currentIndexChanged(const QString &arg1)
{
    if(arg1.toStdString() == "C")
        ui->corrCodeCommandLEdit->setText("gcc -lm");
    if(arg1.toStdString() == "C++")
        ui->corrCodeCommandLEdit->setText("g++ -lm");
    if(arg1.toStdString() == "Other")
        ui->corrCodeCommandLEdit->clear();
}

void MainWindow::on_tstMakerLangCbox_currentIndexChanged(const QString &arg1)
{
    if(arg1.toStdString() == "C")
        ui->tstMakerCommandLEdit->setText("gcc -lm");
    if(arg1.toStdString() == "C++")
        ui->tstMakerCommandLEdit->setText("g++ -lm");
    if(arg1.toStdString() == "Other")
        ui->tstMakerCommandLEdit->clear();
}
